...
<head>
    ...
    <meta name="title" content="{{ $title ?? 'Creative Tech Digital' }}">
    ...
    <meta property="og:title" content="{{ $title ?? 'Creative Tech Digital' }}">
    <meta property="og:url" content="/" />
    <meta property="og:locale" content="{{ app()->getLocale() }}" />
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="{{ $title ?? 'Creative Tech Digital' }}" />
    <meta name="author" content="{{ $title ?? 'Creative Tech Digital' }}">
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $title ?? 'Creative Tech Digital' }}">
